...
Expression* Parser::ParseExpression()
{
    // TODO: Expression
    ParseTerminal(Token::TYPE_LEFT_PAREN);
    Parameter* leftParameter = ParseParameter();
    string charOperator = ParseOperator();
    Parameter* rightParameter = ParseParameter();
    ParseTerminal(Token::TYPE_RIGHT_PAREN);
    Expression* expression = new Expression();
    expression->SetLeftExpression(leftParameter);
    expression->SetRightExpression(rightParameter);
    expression->SetOperatorChar(charOperator);
    return expression;
}
